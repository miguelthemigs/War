...
class Cartas {
    ...
    public static class Territorio {
        ...
        public static final Cartas.Territorio[] allTerritorios = {
                ...
                new Cartas.Territorio("Texas", Cartas.Poligono.triangulo, new String[]{"California","México","NovaYork","Québec","Vancouver"}),
                ...
                new Cartas.Territorio("Paquistão", Cartas.Poligono.bola, new String[]{"Índia", "China", "Turquia", "Síria", "Irã"}),
                new Cartas.Territorio("Rússia", Cartas.Poligono.triangulo, new String[]{"Cazaquistão","Estônia","Letônia","Sibéria"}),
                new Cartas.Territorio("Sibéria", Cartas.Poligono.quadrado, new String[]{"Alasca","Cazaquistão","Rússia"}),
                new Cartas.Territorio("Síria", Cartas.Poligono.quadrado, new String[]{"Paquistão", "Irã", "Iraque", "Jordânia", "Turquia"}),
                ...
                new Cartas.Territorio("Venezuela", Cartas.Poligono.triangulo, new String[]{"Brasil","Peru","México"}),

                new Cartas.Territorio("Espanha", Poligono.bola, new String[]{"Argélia","França"}),
                new Cartas.Territorio("França", Poligono.triangulo, new String[]{"ReinoUnido","Espanha","Itália","Suécia"}),
                new Cartas.Territorio("Itália", Poligono.quadrado, new String[]{"Argélia","França","Polônia","Romênia","Suécia"}),
                new Cartas.Territorio("Polônia", Poligono.triangulo, new String[]{"Itália","Letônia","Ucrânia", "Romênia"}),
                ...
                new Cartas.Territorio("Austrália", Poligono.triangulo, new String[]{"Indonésia","NovaZelândia","Perth"}),
