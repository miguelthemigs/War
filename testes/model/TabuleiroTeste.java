...
public class TabuleiroTeste {
	...
	public void testeTabuleiro() {
		...
		assertEquals("Nome de pais definido indevidamente","África do Sul", Tabuleiro.AfricaSul.getNome());
		assertArrayEquals("Fronteira de pais definido indevidamente",new String[]{"África do Sul","Nigéria","Somália"}, Tabuleiro.Angola.getFronteiras());
